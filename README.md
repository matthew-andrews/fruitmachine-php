# FruitMachine-php [![Build Status](https://travis-ci.org/matthew-andrews/fruitmachine-php.svg?branch=master)](https://travis-ci.org/matthew-andrews/fruitmachine-php)
